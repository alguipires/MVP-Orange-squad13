export function ModalExcluir() {
  const [
    ...
    updateCloseModal2,
    openModalDeletado,
    updateOpenModalDeletado,
  ] = useStore((state) => [
    state.updateOpenModal,
    state.updateOpenModal2,
    state.updateCloseModal2,
    state.openModalDeletado,
    state.updateOpenModalDeletado,
  ]);
    ...
    <Box className="caixaExcluir">
      <section className="modalExcluir">
        ...
        <div className="modalBotaoExcluir">
          ...
          <Button className="botaoCancelar" onClick={handleClose}>
            Cancelar
          </Button>
        </div>
      </section>
...
export function OpenModalExcluir() {
  const [openModal2, updateOpenModal2, updateCloseModal2] = useStore(
    (state) => [
      state.openModal2,
      state.updateOpenModal2,
      state.updateCloseModal2,
